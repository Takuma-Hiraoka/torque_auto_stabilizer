...
void LegCoordsGenerator::initLegCoords(const GaitParam& gaitParam,
  ...
  genCoords.emplace_back(rlegCoords, cnoid::Vector6::Zero(), cnoid::Vector6::Zero(), mathutil::HOFFARBIB);
  genCoords.emplace_back(llegCoords, cnoid::Vector6::Zero(), cnoid::Vector6::Zero(), mathutil::HOFFARBIB);
  cnoid::Vector3 zmp;
