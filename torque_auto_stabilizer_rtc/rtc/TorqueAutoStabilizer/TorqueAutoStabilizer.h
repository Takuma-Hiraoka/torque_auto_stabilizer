...
public:
  ...
  bool setFootSteps(const OpenHRP::TorqueAutoStabilizerService::FootstepSequence& fs);
  bool setFootStepsWithParam(const OpenHRP::TorqueAutoStabilizerService::FootstepSequence& fs, const OpenHRP::TorqueAutoStabilizerService::StepParamSequence& sps);
  void waitFootSteps();
  bool startAutoBalancer();
  bool stopAutoBalancer();
  bool setTorqueAutoStabilizerParam(const OpenHRP::TorqueAutoStabilizerService::TorqueAutoStabilizerParam& i_param);
  bool getTorqueAutoStabilizerParam(OpenHRP::TorqueAutoStabilizerService::TorqueAutoStabilizerParam& i_param);
  bool getFootStepState(OpenHRP::TorqueAutoStabilizerService::FootStepState& i_param);
...
protected:
  ...
  public:
    ...
    torque_auto_stabilizer_msgs::TimedSteppableRegion m_steppableRegion_; // 着地可能領域. 支持脚を水平にした座標系
    RTC::InPort<torque_auto_stabilizer_msgs::TimedSteppableRegion> m_steppableRegionIn_;
    RTC::Time steppableRegionLastUpdateTime_; // m_steppableRegionIn_に最後にdataが届いたときの、m_qRef_.tmの時刻
    torque_auto_stabilizer_msgs::TimedLandingPosition m_landingHeight_; // 着地姿勢. 支持脚を水平にした座標系
    RTC::InPort<torque_auto_stabilizer_msgs::TimedLandingPosition> m_landingHeightIn_;
    ...
    torque_auto_stabilizer_msgs::TimedLandingPosition m_landingTarget_; // 着地位置. 支持脚を水平にした座標系
    RTC::OutPort<torque_auto_stabilizer_msgs::TimedLandingPosition> m_landingTargetOut_;
...
protected:
  ...
  static bool writeOutPortData(TorqueAutoStabilizer::Ports& ports, const TorqueAutoStabilizer::ControlMode& mode, cpp_filters::TwoPointInterpolator<double>& idleToAbcTransitionInterpolator, double dt, const GaitParam& gaitParam);
};
